...
obj.leftHalf = function(windowFrame, screenFrame)
  ...
  if Validate:leftHalf(windowFrame, screenFrame) and repeatResize then
    newFrame = Resize:leftTwoThirds(windowFrame, screenFrame)
  elseif Validate:leftTwoThirds(windowFrame, screenFrame) and repeatResize then
...
obj.topHalf = function(windowFrame, screenFrame)
  ...
  if Validate:topHalf(windowFrame, screenFrame) and repeatResize then
    newFrame = Resize:topTwoThirds(windowFrame, screenFrame)
  elseif Validate:topTwoThirds(windowFrame, screenFrame) and repeatResize then
...
obj.bottomHalf = function(windowFrame, screenFrame)
  ...
  if Validate:bottomHalf(windowFrame, screenFrame) and repeatResize then
    newFrame = Resize:bottomTwoThirds(windowFrame, screenFrame)
  elseif Validate:bottomTwoThirds(windowFrame, screenFrame) and repeatResize then
...
obj.topLeft = function(windowFrame, screenFrame)
  ...
  if Validate:topLeftHalf(windowFrame, screenFrame) and repeatResize then
    newFrame = Resize:topLeftTwoThirds(windowFrame, screenFrame)
  elseif Validate:topLeftTwoThirds(windowFrame, screenFrame) and repeatResize then
...
obj.topRight = function(windowFrame, screenFrame)
  ...
  if Validate:topRightHalf(windowFrame, screenFrame) and repeatResize then
    newFrame = Resize:topRightTwoThirds(windowFrame, screenFrame)
  elseif Validate:topRightTwoThirds(windowFrame, screenFrame) and repeatResize then
...
obj.bottomRight = function(windowFrame, screenFrame)
  ...
  if Validate:bottomRightHalf(windowFrame, screenFrame) and repeatResize then
    newFrame = Resize:bottomRightTwoThirds(windowFrame, screenFrame)
  elseif Validate:bottomRightTwoThirds(windowFrame, screenFrame) and repeatResize then
...
obj.bottomLeft = function(windowFrame, screenFrame)
  ...
  if Validate:bottomLeftHalf(windowFrame, screenFrame) and repeatResize then
    newFrame = Resize:bottomLeftTwoThirds(windowFrame, screenFrame)
  elseif Validate:bottomLeftTwoThirds(windowFrame, screenFrame) and repeatResize then
...
obj.rightHalf = function(windowFrame, screenFrame)
  ...
  if Validate:rightHalf(windowFrame, screenFrame) and repeatResize then
    newFrame = Resize:rightTwoThirds(windowFrame, screenFrame)
  elseif Validate:rightTwoThirds(windowFrame, screenFrame) and repeatResize then
